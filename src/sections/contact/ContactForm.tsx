...
function ContactForm() {
  ...
  return (
    <form
      ...
      className="relative flex w-full max-w-xl flex-col items-start justify-center gap-1 rounded-s bg-primary-900 p-4 shadow-md text-primary-50"
    >
      ...
      <motion.button
        ...
        whileTap={{ scale: 1.01 }}
        className="mx-auto min-w-40 rounded-md bg-action-600 hover:bg-action-700 px-3 py-1 text-xl uppercase text-primary-50 transition-opacity hover:opacity-80"
      >
        Send
      </motion.button>
      <motion.div
